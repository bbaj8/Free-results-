...
async def gen_thumb(thumbnail, title, userid, ctitle):
    ...
    image2 = Image.open(f"mohammed/helpers/other/choose/rrc.png")
    ...
    font = ImageFont.truetype("mohammed/helpers/other/choose/Roboto-Light.ttf", 55)
    font2 = ImageFont.truetype("mohammed/helpers/other/choose/finalfont.ttf", 65)
    draw.text(
        (20, 630),
        f"{title[:25]}...",
        fill="White",
